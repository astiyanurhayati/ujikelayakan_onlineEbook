            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Edit Book Data</h3>
                    </div>
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('book.update', $book['id'])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-3">
                            <label>Writer</label>
                            <input type="text" value="{{$book['writer']}}" class="form-control @error('writer') is-invalid @enderror" name="writer"
                                placeholder="writer">
                            @error('writer')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mt-3 d-flex  bd-highlight " style="gap: 10px">
                            <div class=" flex-fill bd-highlight">
                                ...
                                <input type="text"  value="{{$book['publisher']}}" class="form-control @error('publisher') is-invalid @enderror"
                            ...
                            <div class=" flex-fill bd-highlight">
                                <label>No ISBN</label>
                                <input type="number" value="{{$book['isbn']}}" class="form-control @error('isbn') is-invalid @enderror"
                        ...
                        <div class="mt-3 d-flex  bd-highlight " style="gap: 10px">
                            ...
                            <div class=" flex-fill bd-highlight">
                                ...
                                <input type="text" value="{{$book['synopsis']}}" class="form-control @error('synopsis') is-invalid @enderror"
                        ...
                        <div class="mb-3 max-w-50 mt-2">
                            ...
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <img src="{{asset('img/'. $book->coverbook)}}" style="max-width: 100px" class="img-preview img-fluid mt-2" style="max-width: 200px" alt="">
                          </div>
